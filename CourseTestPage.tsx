...
const CourseTestPage: React.FC = () => {
  ...
  const sequenceQuestions = useMemo(() => [
    {
      id: 'foreign_trade_core_flow',
      question: '请将外贸核心流程的环节按正确顺序排列：',
      items: [
        { id: 'customs_declaration', text: '报关' },
        { id: 'customer_inquiry', text: '寻盘' },
        { id: 'transportation', text: '运输' },
        { id: 'contract_signing', text: '签约' },
        { id: 'goods_preparation', text: '备货' }
      ],
      correctOrder: ['customer_inquiry', 'contract_signing', 'goods_preparation', 'transportation', 'customs_declaration']
    },
    {
      id: 'trade_development_flow',
      question: '请将市场开拓、交易洽谈、合同履行按正确顺序排列：',
      items: [
        { id: 'contract_fulfillment', text: '合同履行' },
        { id: 'transaction_negotiation', text: '交易洽谈' },
        { id: 'market_development', text: '市场开拓' }
      ],
      correctOrder: ['market_development', 'transaction_negotiation', 'contract_fulfillment']
    }
  ], []);
  ...
  const matchingQuestions = useMemo(() => [
    {
      ...
      rightItems: [
        { id: 'r1', text: '负责货物运输安排' },
        { id: 'r2', text: '组织货物出口相关事宜' },
        { id: 'r3', text: '进行外汇结算等金融服务' },
        { id: 'r4', text: '确保国际贸易中的法律合规性' }
      ],
      correctMatches: {
        'l1': 'r2', // 出口商 - 组织货物出口相关事宜
        'l2': 'r1', // 国际货运代理 - 负责货物运输安排
        'l3': 'r3', // 银行 - 进行外汇结算等金融服务
        'l4': 'r4'  // 海关 - 确保国际贸易中的法律合规性
      }
    }
  ], []);
  ...
  const multipleChoice = [
    ...
    {
      id: 'q2',
      question: '以下哪个角色在外贸业务中主要负责确保国际贸易中的法律合规性并处理通关手续？',
      options: [
        'A. 外贸经理',
        'B. 海关',
        'C. 外销员',
    ...
    {
      id: 'q3',
      question: '在外贸业务中，哪项任务通常由外贸单证员负责执行？',
      options: [
        'A. 制定外贸战略',
        'B. 编写外贸合同',
        'C. 审核和制作出口单证',
                  ...
                  <div key={question.id} className="glass-effect rounded-2xl p-8">
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <h4 className="text-accent-500 font-medium mb-4">外贸角色</h4>
                      ...
                      <div className="relative z-10">
                        <h4 className="text-green-300 font-medium mb-4">职责描述</h4>
                        <div className="space-y-3">
              ...
              <div className="text-center">
                ...
                <div className={`p-6 rounded-lg mb-6 ${
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    {score.score >= 80 ? 
                      '恭喜您！您已经很好地掌握了外贸业务的基础知识，可以进入下一阶段的学习。' :
                      score.score >= 60 ?
                      '您对外贸基础知识有一定掌握，建议复习薄弱环节，加强实践练习。' :
                      '建议您重新学习相关章节，特别关注外贸的基本概念、流程和风险控制。'
                    }
                  </p>
              </div>
              </div>
